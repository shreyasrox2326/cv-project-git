...
def main():
    ...
    # The migrated evaluation helpers still consult a separate metadata path at import time.
    # Point them at the dataset root used during training before importing those modules.
    os.environ["CUB_EVAL_DATA_ROOT"] = (Path(hparams.data_root) / "CUB_200_2011").as_posix()
