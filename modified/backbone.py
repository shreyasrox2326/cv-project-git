...
@contextmanager
def _skip_dinov2_weight_init():
    original_init_weights = Dinov2VisionTransformer.init_weights

    def _noop_init_weights(self):
        return None

    Dinov2VisionTransformer.init_weights = _noop_init_weights
    try:
        yield
    finally:
        Dinov2VisionTransformer.init_weights = original_init_weights
